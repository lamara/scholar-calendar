 ...
 * repeating update service that will launch a scholar update process every
 * three hours.
 * 
 * @author Alex Lamar
 * @author Paul Yea
    ...
    extends BroadcastReceiver
{
    ...
    public void onReceive(Context context, Intent intent)
    {
         ...
         * service, 0); AlarmManager alarm = (AlarmManager)
         * context.getSystemService(Context.ALARM_SERVICE); Calendar cal =
         * Calendar.getInstance(); alarm.cancel(pendingIntent); //removes
         * already existing alarms (if they //exist) to prevent duplicates from
         * happening //triggers update service every 3 hours
