...
public class NextWeekSeparator
    extends DateSeparator
{
    ...
    {
        super();
        // set time to the beginning of the next week (if the day is saturday
// then
        // the WeekSeparator and NextWeekSeparator will end up on the same day
// of
    ...
    protected String getSeparatorString()
    {
        ...
        String endWeekString =
            formatter.format(new Date(beginOfWeek.getTime().getTime()
                + SIX_DAYS_MILLI));
        return DUE_NEXT_WEEK + ", " + beginWeekString + LONG_DASH
            + endWeekString;
    }
}
