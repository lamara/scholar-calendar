...
public class TaskTest
{
    ...
    public void setUp() {
        try {
            ...
            assignment1 = new Assignment("HW 10", "EngE 1024", "Jul 4, 2013 12:30 am");
            assignment2 = new Assignment("HW 10", "EngE 1024", "Jul 4, 2013 12:30 am");
            assignment3 = new Assignment("HW 10", "EngE 1024", "Jul 5, 2013 12:30 am");
        }
    ...
    /**
     * Tests two tasks for equality, should return true as they have the
     * same due date, name, and description
     */
    @Test
    ...
    /**
     * Tests mutating a calendar object that was returned from a task, making sure
     * that doing that doesn't affect the calendar object field inside the object
     */
    @Test
