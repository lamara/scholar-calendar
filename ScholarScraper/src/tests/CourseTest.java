...
public class CourseTest
{
    ...
    /**
     * Tests adding tasks to a course, should return Task.NOT_ADDED (0) as duplicate tasks
     * are being added, meaning the task has not been added
     */
    @Test
    ...
    /**
     * Tests adding tasks to a course, should return Task.REPLACED (-1) as the same
     * task is added but with a different due date
     */
    @Test
